    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="form" method="post" action="?action=add">
              <div class="row">
                <div class="col-sm-2">
                  <label class="detail-label" for="hoten">Mã liên lạc: </label>
                </div>
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="mll" id="hoten" value="">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-2">
                ...
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="hoten" id="hoten" value="">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="ngaysinh" id="hoten" value="">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="email" id="hoten" value="">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="diachi" id="hoten" value="">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <input class="detail-input" type="text" name="nickname" id="hoten" value="">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" rows="3" name="ghichu" id="note"></textarea>
                </div>
              </div>
